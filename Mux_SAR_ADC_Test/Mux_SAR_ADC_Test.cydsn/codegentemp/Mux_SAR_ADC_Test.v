// ======================================================================
// Mux_SAR_ADC_Test.v generated from TopDesign.cysch
// 04/25/2023 at 10:21
...
module ADC_SAR_SEQ_v2_10_1 (
	...
	cy_clock_v1_0
		#(.id("9a1a47a3-e007-4a36-8f71-144818843060/9725d809-97e7-404e-b621-dfdbe78d0ca9"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("9a1a47a3-e007-4a36-8f71-144818843060/3d23b625-9a71-4c05-baf4-2f904356009b"),
...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("d81d9db7-cd5e-4b43-87ec-c0383f99324b/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed89fdf4-a21d-4301-9237-f46124ffd60d"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8b3d9df5-86f9-4ed4-b0d9-a643e0ee95ca"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2e3ae9e3-7fad-4dc1-8c83-d29eef44bbee"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ca2cd3cd-e0f3-4197-b0df-259b17c193dc"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("44c907b5-45c5-4db0-bdae-e0534c554d4d"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
